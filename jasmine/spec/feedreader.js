...
$(function() {
  ...
  describe('RSS Feeds', function() {
    ...
    /* added a test that loops through each feed
  ...
  /* added a new test suite named "The menu" */

  describe('The menu', function() {

    /* added a test that ensures the menu element is
    ...
    /* added a test that ensures the menu changes
  ...
  /*  added a new test suite named "Initial Entries" */
  describe('Initial Entries', function() {
    ...
    /* added a test that ensures when the loadFeed
  ...
  describe('New Feed Selection', function() {
    ...
    /* added a test that ensures when a new feed is loaded
